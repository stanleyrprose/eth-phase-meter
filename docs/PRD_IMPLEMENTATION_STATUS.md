...
- Reliable external sampling clock: Mac mini launchd checks current GitHub run buckets at :20 hourly and dispatches missing 4H Strategic or 1H Tactical workflows; production compute workflows are dispatch-only to avoid delayed GitHub cron duplicates. GitHub 4H/1H watchdogs remain best-effort :45 recovery paths. 1H PIT nominal buckets, latest-4H confirmation, combined 1H+4H boundary artifacts, and change-driven Telegram semantics are preserved.

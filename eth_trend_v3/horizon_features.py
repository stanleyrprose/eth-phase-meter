...
def external_feature_contracts() -> list[FeatureMeta]:
    ...
    return [
        ...
        FeatureMeta("staking_netflow_eth", "v2", "Etherscan PIT delta / optional Dune", "24h validator deposit-contract inflow minus Beacon withdrawals", "24h", "derived only from current and prior canonical PIT snapshots; optional Dune remains parallel enrichment", "Etherscan cumulative counters / Dune query-specific", "mark_missing", "structural_supply", "7d,30d", retrieval_time_field="observed_at"),

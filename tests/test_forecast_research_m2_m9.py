...
def test_promotion_hard_gate_and_manual_override_cannot_promote():
    evidence={"leakage_free":True,"pit_valid":True,"registry_complete":True,"artifact_valid":True,"train_serve_parity":True,"shadow_complete":True,"data_health_normal":True,"emergency_freeze_clear":True,"holdout_clean":True,"effective_shadow_confirmed":True,"research_brier_skill":.03,"shadow_brier_skill":.02,"data_health":"NORMAL","calibration_error":.08}
